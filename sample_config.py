...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@o_5_h")
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/eyad2096/telthon1")
    AUTONAME = os.environ.get("AUTONAME", "@o_5_h")
    ...
    THUMB_IMAGE = os.environ.get("THUMB_IMAGE", "https://graph.org/file/d528d1f16ca4746aaea96.jpg")
