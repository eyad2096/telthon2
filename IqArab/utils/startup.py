...
async def startupmessage():
    try:
        if BOTLOG:
            Config.CATUBLOGO = await iqthon.tgbot.send_file(BOTLOG_CHATID, "https://graph.org/file/b7a5e1aa94be43eafc668.mp4", caption="🝳 ⦙ تـمّ  اعـادة تشـغيل\n تليثـون  ✓  :  [ 8.2 ] .\n\n🝳 ⦙ للحصول على اوامر السورس\n أرسـل : (  `.اوامري`  ) \n\n🝳 ⦙ لمـعرفة كيفية تغير بعض كلايش\n او صور السـورس  أرسـل  :\n (  `.مساعده`  )\n\n🝳 ⦙ القناة الرسمية تليثون العرب : @o_5_h\n🝳 ⦙ فارات سورس تليثون  :@z_n_u \n🝳 ⦙ كلايش تليثون :  @F_c_c\n 🝳 ⦙التحديثات والاضافات :  @o_5_h\n",                buttons=[(Button.url("مطور تليثون الرسمي", "https://t.me/m_r_r"),)],            )
    except Exception as e:
        LOGS.error(e)
        return None
...
async def iqchn():
    ...
    try:
        ...
        await iqthon(JoinChannelRequest("@z_n_u"))
    except BaseException:
        pass
