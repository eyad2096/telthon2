...
AUTOGRCH = ""
FONTGRCH1 = "1727322857"
FONTGRCH2 = gvarstatus("FONTGRCH") or "1727322857"
...
digitalpfp = (gvarstatus("AUTO_PIC") or "https://telegra.ph/file/1a84b58f109e17736fd5b.jpg")
...
async def _(event):
    ...
    try:
        ...
        if photo:
            await catevent.edit("**⚘ ⦙   أشترك @o_5_h **")
