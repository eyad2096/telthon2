...
async def iq(iqthonevent):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "𝗐𝖾𝗅𝖼𝗈𝗆𝖾 𝗍𝖾𝗅𝖾𝗍𝗁𝗈𝗇 to source levi 𓃠"
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://graph.org/file/b7a5e1aa94be43eafc668.mp4"
...
async def _(event):
    ...
    OUTPUT = (f"⚘︙  وحـدة المعلومات الخاصه بتنصيبك مع جميع الفارات  لتنصيب سورس تليثون @o_5_h :**\n\n{o}")
...
قناة الكلايش  : @o_5_h
قناه شروحات الاوامر  : @z_n_u
قناه المتغيرات او الفارات : @o_5_h""")
...
https://t.me/Teamtelethon/51
———————×——————— 
قناه المتغيرات او الفارات : @z_n_u
شرح الأوامر : ( @o_5_h ) .
قناه السورس : ( @o_5_h ) .
جميع الاوامر تكون بدايتها نقطة .
""")
